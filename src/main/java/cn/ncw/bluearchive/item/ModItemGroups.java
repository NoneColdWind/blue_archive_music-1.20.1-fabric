...
public class ModItemGroups {
    ...
    private static RegistryKey<ItemGroup> register(String id) {
        return RegistryKey.of(RegistryKeys.ITEM_GROUP, new Identifier(BlueArchiveMusicMod.MOD_ID, id));
    }
                ...
                ItemGroup.create(ItemGroup.Row.TOP, -1)
                        ...
                        .entries((displayContext, entries) -> {
                            for (String music_name : BlueArchiveMusicNames) {
                                entries.add(ModItems.BlueArchiveMusicDiscItems.get(music_name));
                            }
                        })
                        .build()
